(() => {
  ...
  var DataFetch = class {
    ...
    async xml(src) {
      return (0, import_rss_to_json.parse)(src, {
  ...
  // 0-exercices/2-exercice/correction/src/js/modal-article.js
  ...
  // 0-exercices/2-exercice/correction/src/js/current-news.js
  var CurrentNews = class _CurrentNews extends HTMLElement {
    ...
    replaceWith(template, data) {
      return template.replace(/{{title}}/g, data.title).replace(/{{thumbnail.url}}/g, data.media.thumbnail.url).replace(/{{pubDate}}/g, this.getFrDate(data.pubDate)).replace(/{{author}}/g, data.author).replace(/{{link}}/g, data.link).replace(/{{description}}/g, data.description);
    }
    /**
  ...
  // 0-exercices/2-exercice/correction/src/js/index.js
  window.onload = () => {
