(() => {
  // 0-exercices/1-exercice/correction/src/js/sign-in.js
  var SignIn = class extends HTMLElement {
    ...
    disconnectedCallback() {
      console.info("supprim\xE9 du DOM");
    }
    /**
     * Rendu HTML
     * @returns void
    ...
    <form>
      ...
      <div class="my-3">
        <p class="form-help"></p>
        <input type="password" class="form-control" name="password" placeholder="mot de passe" autocomplete="off">     </div>
      <div class="my-3">
  ...
  // 0-exercices/1-exercice/correction/src/js/index.js
  window.onload = () => {
