import { getHelpMessages } from './helpMessage'

class AuthUser extends HTMLElement {
  // static variables propre à la classe, "globale à toutes les instances (objets)"
  static SIGN_IN_TPL = './../../../../1-exercice/correction/src/html/_partials/sign-in.html'
  static SIGN_UP_TPL = './../../../../1-exercice/correction/src/html/_partials/sign-up.html'
